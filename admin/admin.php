...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($_GET['page_layout'] == 'user'){echo 'active';} ?> <?php if($_SESSION['level'] > 1) echo "disabled"?>" ><a <?php if($_SESSION['level'] == 1) echo 'href="index.php?page_layout=user"'?>><svg class="glyph stroked male user "><use xlink:href="#stroked-male-user"/></svg>Quản lý thành viên</a></li>
