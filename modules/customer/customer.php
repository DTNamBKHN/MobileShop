<?php
 ...
 if(isset($_POST['email'])){
    if($_POST['email'] != '' && $_POST['phone'] != '' && $_POST['email'] != '' && $_POST['address'] != '' && isset($_SESSION['cart'])){
        $name = $_POST['name'];
        $phone = $_POST['phone'];
        $email = $_POST['email'];
        ...
        $html = '<div style="border: 1px dotted forestgreen;">
            ...
            $html .= '<tr style="font-size: 30px; font-weight: bold; color: red;">
                ...
                <p align="center" style="font-weight: bold;">Cảm ơn bạn đã mua hàng bên BKshop</p>';
                ...
                try {
                    ...
                    $mail->Username   = 'thanhnamdo2016@gmail.com';            // SMTP username
                    $mail->Password   = 'fwmuprguscoppfsx';                     // SMTP password
